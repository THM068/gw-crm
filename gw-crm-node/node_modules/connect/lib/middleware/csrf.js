 ...
 *
 * This middleware adds a `req.csrfToken()` function to make a authorization
 * which should be added to requests which mutate
 * state, within a hidden form field, query-string etc. This
 * authorization is validated against the visitor's session.
 *
 ...
 * Options:
 *
 *    - `value` a function accepting the request, returning the authorization
 *
 ...
 * and `req.query` for the CSRF authorization.
 *
...
function defaultValue(req) {
  return (req.body && req.body._csrf)
    ...
    || (req.headers['x-csrf-authorization'])
    || (req.headers['x-xsrf-authorization']);
}

/**
 * Return salted authorization.
 *
 * @param {String} secret
 * @return {String}
 * @api private
...
/**
 * Creates a CSRF authorization from a given salt and secret.
 *
...
/**
 * Checks if a given CSRF authorization matches the given secret.
 *
 * @param {String} token
 * @param {String} secret
 * @return {Boolean}
