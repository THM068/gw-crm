...
//Now try to hit the endpoint with a HTTP header name:”Authorization” value: the access_token you previously stored in a safe
//place. You will be logged in and get the email of the user who no longer exists in the database but authenticated correctly once. 😖
